...
async def create(
    ...
    Args:
        ...
        activity_id: Optional functional ID (RFC 4122 UUID). If not provided, auto-generated by model.
...
async def get_by_activity_id(
    ...
    """
    Get an activity by functional ID (RFC 4122 UUID).

    Args:
        session: Async database session
        activity_id: Activity functional ID (UUID string)
